...
\begin{figure*}[ht!]
    ...
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/AllIn_Accuracy_Kernel.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/AllIn_Training_Kernel.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/AllIn_Testing_Kernel.pdf}}\quad
    
     \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/AllIn_Accuracy_PCA.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/AllIn_Training_PCA.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/AllIn_Testing_PCA.pdf}}\quad   

    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/AllIn_Accuracy_Cost.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/AllIn_Training_Cost.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/AllIn_Testing_Cost.pdf}}\quad
