...
\begin{figure*}[ht!]
    ...
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/Accuracy_kernel.png}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/Accuracy_pca.png}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/accuracy_costlog.png}}\quad
