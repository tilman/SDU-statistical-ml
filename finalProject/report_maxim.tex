...
\begin{figure*}[ht!]
    ...
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/Disjunct_Accuracy_Kernel.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/Disjunct_Training_Kernel.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/Disjunct_Testing_Kernel.pdf}}\quad
    
     \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/Disjunct_Accuracy_PCA.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/Disjunct_Training_PCA.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/Disjunct_Testing_PCA.pdf}}\quad   

    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/Disjunct_Accuracy_Cost.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/Disjunct_Training_Cost.pdf}}\quad
    \subfloat[][]{\includegraphics[width=0.3201\linewidth]{finalProject/SVM/Images/Disjunct_Testing_Cost.pdf}}\quad
